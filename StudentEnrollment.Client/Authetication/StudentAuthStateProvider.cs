...
namespace StudentEnrollment.Client.Authetication
{
    public class StudentAuthStateProvider : AuthenticationStateProvider
    {
        ...
        public StudentAuthStateProvider(BrowserStorageService browserStorageService)
        {
            _browserStorageService = browserStorageService;
            AuthenticationStateChanged += StudentAuthStateProvider_AuthenticationStateChanged;
        }

        private async void StudentAuthStateProvider_AuthenticationStateChanged(Task<AuthenticationState> task)
        {
